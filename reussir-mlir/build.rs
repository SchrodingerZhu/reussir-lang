mod mlir {
    ...
    pub fn run() -> Result<(), Box<dyn Error>> {
        println!("cargo:rerun-if-changed=include/Reussir/CAPI.h");
...
fn main() {
    ...
    println!("cargo:rustc-link-lib=static=MLIRReussirCAPI");
    println!("cargo:rustc-link-lib=static=MLIRReussir");
    println!("cargo:rustc-link-lib=static=MLIRReussirPasses");
    println!("cargo:rustc-link-lib=static=MLIRReussirAnalysis");
    println!("cargo:rustc-link-lib=static=MLIRReussirInterfaces");
    mlir::run().unwrap();
}
